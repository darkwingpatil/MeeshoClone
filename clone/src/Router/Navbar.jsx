...
<div className={styles.logoMeesho}><img src="https://github.com/darkwingpatil/sudoku/blob/main/messhopng.png?raw=true" alt="WebsiteLogo" onClick={()=>{
  navigate("/")}}/></div>
<div className="App">
...
{
hidesea?<div style={{position:"absolute",top:"8%",left:"21.5%",background:"white",height:"300px",width:"300px",zIndex:4,border:"1px solid lightgrey"}} onMouseLeave={()=>sethidesea(false)}>
{
mydata.map((ele)=>{
